...
bpy.data.scenes["Scene"].cycles.samples = 60
...
#Disable Hair
bpy.data.scenes["Scene"].cycles_curves.use_curves = 1
...
bpy.data.scenes["Scene"].cycles.sample_clamp_indirect = 0

bpy.data.scenes["Scene"].cycles.blur_glossy = 0
